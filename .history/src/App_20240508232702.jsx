...
function Pizza(props) {
    ...
    return (
        <div className={`pizza ${props.sold-out && "sold-out"}`}>
...
const Menu =()=>{
    return (
        ...
        {pizzaData.map((data) =>{
            return <Pizza name={data.name} ingredients={data.ingredients} price={data.price} photoName={data.photoName} sold-out={data.soldOut}/>
        })}
        </div>
        </main>
    )
