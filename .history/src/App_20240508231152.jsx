...
const Menu =()=>{
    return (
        ...
        {pizzaData.map((data) =>{
            return <Pizza name={data.name} ingredients={data.ingredients} price={data.price} photoName='/pizzas/funghi.jpg'/>
        })}
        <Pizza name="Pizza spinachi" ingredients='Tomatos' price={10} photoName='/pizzas/funghi.j/>
        </main>
    )
}
const Footer =()=>{
