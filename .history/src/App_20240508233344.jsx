...
const Footer =()=>{
    ...
    if(!isopen){
        return (
            <p>We're happy to welcome uou between {openHour}:00 and {closeHour</p>
            ); 
    }
    return (
    <footer className='footers'> We're open until {closeHour}:00 .Come visit us or order online</footer>
    );
}
